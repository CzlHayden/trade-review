...
const DEFS: FlagDef[] = [
  ...
  },
  {
    ...
    kind: "behavior",
    defaultSeverity: "warn",
    summary: "No protective stop order was found for this trade.",
    why: "Without a resting stop the downside is unbounded and R can't be measured.",
  },
  {
    id: "wide_stop",
    title: "Wide stop",
    ...
    kind: "behavior",
    defaultSeverity: "warn",
    summary: "The initial stop sat further below entry than your max-loss cap.",
  ...
  },
  {
    ...
    kind: "behavior",
    defaultSeverity: "warn",
    summary: "You moved a protective stop further from price during the trade.",
    why: "Widening a stop to avoid a loss is the classic account-destroying mistake.",
  },
  {
    id: "improper_pyramid",
