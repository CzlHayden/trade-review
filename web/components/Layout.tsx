...
import { useSyncStatus, useStartSync, useTheme, type ThemeMode } from "../lib/hooks";
...
function SyncControl() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <span className={`status-dot ${dotClass}`} title={title} />
      <button className="btn" disabled={running} onClick={() => start.mutate()} title={title}>
